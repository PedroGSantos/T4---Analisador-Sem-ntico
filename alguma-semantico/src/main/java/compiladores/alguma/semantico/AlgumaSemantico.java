...
import static compiladores.alguma.semantico.AlgumaSemanticoUtils.confereTipo;
import compiladores.alguma.semantico.TabelaDeSimbolos.TipoEntrada;
...
public class AlgumaSemantico extends AlgumaBaseVisitor<Void> {
    ...
    // Hash Map para guardar dados e nomes de parametros de uma função
